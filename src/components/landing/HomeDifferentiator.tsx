      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl p-7">
            <p className="text-label font-semibold uppercase text-gray-400 dark:text-gray-500 mb-5">
              Traditional property software
            </p>
            <ul className="space-y-3">
              {TRADITIONAL.map((t) => (
                <li key={t} className="flex items-center gap-3 text-body text-gray-500 dark:text-gray-400">
          ...
          <div className="bg-header dark:bg-gold/10 border border-header dark:border-gold/30 rounded-2xl p-7">
            ...
            <ul className="space-y-3">
              {GROUNDWORK.map((t) => (
                <li key={t} className="flex items-center gap-3 text-body text-white dark:text-gray-100">
        ...
        <p className="text-center text-gray-500 dark:text-gray-400 text-body-lg max-w-xl mx-auto mt-10">
          Success isn&apos;t about how much information you have — it&apos;s whether the right people take the right action at the right time.
        </p>
        <p className="text-center text-caption text-gray-400 dark:text-gray-500 mt-5">
