    ...
    <div className="min-h-screen">
      ...
      <section className="px-6 py-14 bg-cream dark:bg-[#091525] border-t border-gray-100 dark:border-white/10 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <a
            href="/signup"
            className="inline-block bg-header dark:bg-gold text-white dark:text-header font-semibold text-body px-8 py-3 rounded-lg hover:bg-header/90 dark:hover:bg-gold/90 transition-colors"
          >
            Start free trial →
          </a>
        </div>
