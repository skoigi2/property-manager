    ...
    >
      ...
      <div className="bg-header px-4 py-3 flex items-center gap-1.5">
        ...
        <div className="flex-1 mx-4">
          <div className="bg-header/60 rounded-md py-1 px-3 text-center max-w-xs mx-auto">
            <span className="text-white/40 text-caption tabular-nums">groundworkpm.com</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-cream dark:bg-[#091525] p-5">
        <div className="flex justify-between items-center mb-5">
          <span className=" text-body font-medium text-header dark:text-white">Al Seef Residences · Manama</span>
          <span className="text-caption text-gray-400 bg-white dark:bg-[#162032] px-3 py-1.5 rounded-lg border border-gray-100 dark:border-white/10">
            April 2026
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          <div className="bg-white dark:bg-[#162032] rounded-xl p-4 border border-gray-100 dark:border-white/10 shadow-card">
            <p className="text-label text-gray-400 uppercase mb-1">Monthly Income</p>
            <p className="text-h2 text-header dark:text-white">BD 24,750</p>
            <span className="inline-flex items-center gap-1 mt-2 text-caption text-income bg-green-50 dark:bg-green-950/50 px-2 py-0.5 rounded-full ">
          ...
          <div className="bg-white dark:bg-[#162032] rounded-xl p-4 border border-gray-100 dark:border-white/10 shadow-card">
            <p className="text-label text-gray-400 uppercase mb-1">Occupancy Rate</p>
            <p className="text-h2 text-header dark:text-white">92%</p>
          ...
          <div className="bg-white dark:bg-[#162032] rounded-xl p-4 border border-gray-100 dark:border-white/10 shadow-card">
            <p className="text-label text-gray-400 uppercase mb-1">Pending Maintenance</p>
            <p className="text-h2 text-gold-dark">3</p>
            <span className="inline-flex items-center gap-1 mt-2 text-caption text-red-500 bg-red-50 dark:bg-red-950/40 px-2 py-0.5 rounded-full ">
              2 overdue
            </span>
          </div>

          <div className="bg-white dark:bg-[#162032] rounded-xl p-4 border border-gray-100 dark:border-white/10 shadow-card">
            <p className="text-label text-gray-400 uppercase mb-1">Owner Reports</p>
            <p className="text-h2 text-header dark:text-white">12</p>
            <p className="text-caption text-gray-400 mt-2">Sent this month</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white dark:bg-[#162032] rounded-xl p-4 border border-gray-100 dark:border-white/10">
            <div className="flex justify-between items-center mb-3">
              <span className="text-caption font-semibold text-header dark:text-white">Recent Income</span>
              <span className="text-caption text-gold ">View all →</span>
            </div>
            {[
              ...
              <div key={row.unit} className="flex justify-between items-center py-2 border-b border-gray-50 dark:border-white/5 last:border-0">
                <span className="text-caption text-gray-500 dark:text-gray-400 ">{row.unit}</span>
                <span className="text-caption font-semibold text-income ">{row.amount}</span>
              </div>
            ))}
          </div>

          <div className="bg-white dark:bg-[#162032] rounded-xl p-4 border border-gray-100 dark:border-white/10">
            <p className="text-caption font-semibold text-header dark:text-white mb-3">Rent Collection</p>
            ...
            <div className="flex gap-3 mt-2.5 flex-wrap">
              {[
                ...
                <span key={item.label} className="flex items-center gap-1 text-caption text-gray-500 dark:text-gray-400 ">
  ...
  return (
    <section className="py-24 px-6 bg-cream-dark dark:bg-[#091525]">
      <div className="max-w-3xl mx-auto">
        <p className="text-center text-label tabular-nums uppercase text-gold-dark dark:text-gold/80 mb-2">
          Sample property — Al Seef Residences (20 units, Bahrain)
        </p>
        <p className="text-center text-body text-gray-500 dark:text-gray-400 mb-10 max-w-xl mx-auto">
