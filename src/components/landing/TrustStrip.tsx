  ...
  return (
    <section className="py-12 border-y border-gold/10 dark:border-white/10 bg-white dark:bg-[#111F30]">
      <div className="max-w-4xl mx-auto px-6 text-center space-y-5">
        <p className="text-body md:text-body-lg text-gray-600 dark:text-gray-300 ">
          Built for modern property operations teams across emerging and established markets.
        </p>

        <ul className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-caption md:text-body text-gray-400 dark:text-gray-500">
          {markets.map((m, i) => (
        ...
        <p className="text-caption text-gray-400 dark:text-gray-500 italic pt-2">
