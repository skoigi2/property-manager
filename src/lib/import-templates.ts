...
export function downloadInvoicesTemplate() {
  ...
  const instructions: (string | number)[][] = [
    ...
    ["Period Month",   "Yes", "1–12",       "Billing month. One RENT invoice per tenant per billing month; deposit/fee-only invoices may be added"],
...
export function downloadExpensesTemplate() {
  const validCategories =
    ...
    "GARBAGE_COLLECTION, LANDSCAPING, PEST_CONTROL, POOL, GENERATOR, ELEVATOR, " +
    "HVAC, GAS, INSURANCE, PROPERTY_TAX, " +
