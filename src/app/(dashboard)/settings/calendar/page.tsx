...
function CopyField({ value, hint }: { value: string; hint: string }) {
  ...
  return (
    <div className="flex items-center gap-2 min-w-0">
      <code className="flex-1 min-w-0 truncate bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs font-mono text-gray-600">
        {value}
      </code>
      <button
        onClick={() => {
        ...
        title={hint}
        className="shrink-0 inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg border border-gray-200 text-xs font-sans text-gold hover:bg-gold/5 transition-colors"
      >
  ...
  return (
    <div>
      ...
      <div className="page-container space-y-4 pb-24 lg:pb-8">
        ...
        <Card>
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <h2 className="font-display text-base text-gray-900">Subscribe in your own calendar</h2>
              <p className="text-sm text-gray-500 font-sans mt-1 leading-relaxed">
        ...
        {/* ── Create ──────────────────────────────────────────────────────── */}
        <Card>
          <h3 className="font-sans font-medium text-sm text-gray-800 mb-3">New feed</h3>
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_1fr_auto] gap-3 items-end">
            ...
            />
            <div>
              <label className="block text-sm font-sans text-gray-600 mb-1.5">Properties</label>
              <select
                value={scope}
                onChange={(e) => setScope(e.target.value)}
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm font-sans focus:outline-none focus:ring-2 focus:ring-gold/40"
              >
            ...
            {feeds.map((f) => (
              <Card key={f.id}>
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="min-w-0">
                    <p className="font-sans font-medium text-sm text-gray-800 truncate">{f.label}</p>
                  ...
                  <button
                    ...
                    className="shrink-0 inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg border border-gray-200 text-xs font-sans text-expense hover:bg-red-50 transition-colors"
                  >
                ...
                <div className="space-y-2">
                  <div>
                    <p className="text-[11px] uppercase tracking-wide text-gray-400 font-sans mb-1">
                      Subscription URL
                    </p>
                ...
                <div className="mt-3 flex items-start gap-2 bg-blue-50 border border-blue-100 rounded-lg px-3 py-2">
                  ...
                  <p className="text-xs text-blue-800 font-sans leading-relaxed">
        ...
        <Card>
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="min-w-0">
              <h3 className="font-sans font-medium text-sm text-gray-800">One-off download</h3>
              <p className="text-xs text-gray-400 font-sans mt-0.5">
            ...
            <a
              ...
              className="shrink-0 inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-gray-200 text-sm font-sans text-gray-600 hover:text-gold hover:border-gold transition-colors"
            >
        ...
        <a
          href="/calendar"
          className="inline-flex items-center gap-1.5 text-sm text-gold hover:underline font-sans"
        >
