...
|---|---|---|---|
| 0:00–0:15 | `/maintenance` | Land on Maintenance; click "Log Job"; fill title ("Leaking kitchen tap") and property; save | Report a maintenance job the way you always do. |
...
| 1:15–1:40 | `/cases/[id]` | Click the next stage node on the stage tracker; confirm "Advance" in the modal | As work progresses, advance the stage. Forward only — going back needs a written reason. |
