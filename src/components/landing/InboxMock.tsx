      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#162032] shadow-card overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-white/10 flex items-center justify-between bg-cream dark:bg-[#0C1B2E]">
            <h3 className=" text-h3 text-header dark:text-white">Today: 3 things need you.</h3>
            <span className="text-label tabular-nums uppercase text-gray-400 dark:text-gray-500">Inbox</span>
          </div>
              ...
              return (
                <li key={idx} className={clsx("px-5 py-4 flex items-start gap-3 border-l-4", s.bg)}>
                  ...
                  <div className="flex-1 min-w-0">
                    <p className=" font-semibold text-body text-header dark:text-white ">
                      {row.title}
                    </p>
                    {row.amountLabel && (
                      <p className="text-caption text-gray-500 dark:text-gray-400 mt-0.5">{row.amountLabel}</p>
                    )}
                    <div className="flex flex-wrap items-center gap-1.5 mt-2">
                      <span className="inline-flex items-center text-caption font-medium px-2 py-0.5 rounded-full bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-300">
                        {row.propertyChip}
                      </span>
                    ...
                    <p className="text-caption italic text-gray-500 dark:text-gray-400 mt-2 ">
                  ...
                  <button
                    type="button"
                    className="hidden sm:inline-flex items-center px-3 py-2 rounded-lg bg-header text-white text-caption font-semibold hover:bg-header/90 transition-colors shrink-0"
                  >
                    {row.actionLabel}
                  </button>
                </li>
